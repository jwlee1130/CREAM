                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="image-placeholder" style="background-color: #d8dde1">
                                ...
                                <button style="cursor: pointer;"><a href="front?key=product&methodName=detail&no=19">지금 보러가기</a></button>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="image-placeholder" style="background-color: #69644b;">
                                <div class="slider-inner">
                                    ...
                                    <button style="cursor: pointer;" ><a href="front?key=product&methodName=detail&no=117">지금 보러가기</a></button>
                                </div>
                            </div>
                        </div>x
                        <div class="swiper-slide">
